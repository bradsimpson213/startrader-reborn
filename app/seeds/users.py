...
def seed_users():
    ...
    user_5 = User(
                ...
                species=1, 
                bio='Princess Leia Organa was one of the greatest leaders of the Rebel Alliance, fearless on the battlefield and dedicated to ending the Empire’s tyranny.',
                faction=False, 
                credits=3000000, 
    ...
    user_6 = User(      
                ...
                species=1, 
                bio="Owen Lars continued his father Cliegg’s efforts to build his homestead into a productive farm, working alongside his wife, Beru.",
                faction=True, 
                credits=50000, 
    ...
    user_8 = User(
                ...
                species=2, 
                bio="A red astromech droid, R5-D4 thought he'd found a home when the Jawas sold him to Owen Lars, along with the protocol droid C-3PO.",
                faction=True, 
                credits=15000, 
    ...
    user_9 = User(
                ...
                species=1, 
                bio="Biggs Darklighter grew up on Tatooine with Luke Skywalker, and shared his friend's dreams of escaping the dull desert world.",
                faction=True, 
                credits=34560, 
    ...
    user_10 = User(
                ...
                species=1, 
                bio="A legendary Jedi Master, Obi-Wan Kenobi was a noble man and gifted in the ways of the Force.",
                faction=True, 
                credits=1000000, 
    ...
    user_11 = User(      
                ...
                species=1, 
                bio="Discovered as a slave on Tatooine by Qui-Gon Jinn and Obi-Wan Kenobi, Anakin Skywalker had the potential to become one of the most powerful Jedi ever.",
                faction=True, 
                credits=65000, 
    ...
    user_12 = User(      
                ...
                species=1, 
                bio="An ambitious, ruthless proponent of military power, Wilhuff Tarkin became a favorite of Supreme Chancellor Palpatine and rose rapidly through the Imperial ranks.",
                faction=False, 
                credits=2000000, 
    ...
    user_13 = User(      
                ...
                species=3, 
                bio="A legendary Wookiee warrior and Han Solo’s longtime co-pilot, Chewbacca continues to serve as faithful first mate to carry out daring missions against the First Order behind the controls of the Millennium Falcon.",
                faction=True, 
                credits=500000, 
    ...
    user_14 = User(
                ...
                species=1, 
                bio="Han Solo rose from an impoverished childhood on the mean streets of Corellia to become one of the heroes of the Rebel Alliance.",
                faction=True, 
                credits=25000, 
    ...
    user_15 = User(
                ...
                species=4, 
                bio="Greedo was a Rodian bounty hunter with a tapir-like snout, bulbous eyes, pea-green skin, and a crest of spines atop his skull.",
                faction=False, 
                credits=125000, 
    ...
    user_17 = User(      
                ...
                species=23, 
                bio="A deadly, agile Sith Lord trained by the evil Darth Sidious, Darth Maul was a formidable warrior and scheming mastermind.",
                faction=False, 
                credits=143000, 
    ...
    user_19 = User(      
                ...
                species=1, 
                bio="Jek Tono Porkins, nicknamed 'Piggy', was a male human trader and pilot from Bestine IV.",
                faction=True, 
                credits=5000, 
    ...
    user_20 = User(      
                ...
                species=6, 
                bio="Yoda was a legendary Jedi Master and stronger than most in his connection with the Force. Small in size but wise and powerful, he trained Jedi for over 800 years.",
                faction=True, 
                credits=10000000, 
    ...
    user_21 = User(      
                ...
                species=1, 
                bio="The dark side of the Force is a pathway to many abilities some consider to be unnatural, and Sheev Palpatine is the most infamous follower of its doctrines.",
                faction=False, 
                credits=1000000000, 
    ...
    user_22 = User(      
                ...
                species=1, 
                bio="With his customized Mandalorian armor, deadly weaponry, and silent demeanor, Boba Fett was one of the most feared bounty hunters in the galaxy.",
                faction=False, 
                credits=750000, 
    ...
    user_24 = User(      
                ...
                species=7, 
                bio="One of the most feared bounty hunters of the galaxy, Bossk used his natural Trandoshan hunting instincts to capture his prey.",
                faction=False, 
                credits=500000, 
    ...
    user_25 = User(
                ...
                species=1, 
                bio="Lando Calrissian may have come late to the fight against the Empire, but his role in destroying the second Death Star cemented his reputation as a hero",
                faction=True, 
                credits=3000000, 
    ...
    user_26 = User(
                ...
                species=2, 
                bio="Never far from Baron Administrator Lando Calrissian's side was Lobot, Calrissian's aide and Cloud City's computer liaison officer.",
                faction=True, 
                credits=25000, 
    ...
    user_27 = User(      
                ...
                species=8, 
                bio="A veteran commander, Ackbar led the defense of his homeworld, Mon Cala, during the Clone Wars and then masterminded the rebel attack on the second Death Star at the Battle of Endor.",
                faction=True, 
                credits=500000, 
    ...
    user_28 = User(
                ...
                species=1, 
                bio="A leader of the Galactic Senate's Loyalist faction, Mon Mothma opposed Supreme Chancellor Palpatine's policies during the final days of the Republic.",
                faction=True, 
                credits=250000, 
    ...
    user_29= User(     
                ...
                species=1, 
                bio="Arvel Crynyd was a male human pilot who served in the Alliance to Restore the Republic during the Galactic Civil War.",
                faction=True, 
                credits=120000, 
    ...
    user_30 = User(
                ...
                species=9, 
                bio="Wicket W. Warrick was the brave young Ewok who willingly joined the Rebellion and aided in the battle against the Empire on the forest moon of Endor.",
                faction=True, 
                credits=50000, 
    ...
    user_31 = User(
                ...
                species=10, 
                bio="A native of Sullust, Nien Nunb was a smuggler who fought for both the Rebel Alliance and the Resistance during his long career.",
                faction=True, 
                credits=152000, 
    ...
    user_31 = User(
                ...
                species=1, 
                bio="A venerable if maverick Jedi Master, Qui-Gon Jinn was a student of the living Force.",
                faction=True, 
                credits=555000, 
    ...
    user_32 = User(
                ...
                species=13, 
                bio="Watto was a Toydarian junk dealer in Mos Espa who bought Shmi Skywalker and her son Anakin from Gardulla the Hutt.",
                faction=True, 
                credits=237000, 
